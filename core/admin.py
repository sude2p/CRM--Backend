...
from .models import CustomUser, UserDetail, OrganizationDetail
...
class CustomUserAdmin(BaseUserAdmin):
    ...
    ordering = ('email',)
    filter_horizontal = ('groups', 'user_permissions',)  # Enable filter_horizontal for groups and permissions
